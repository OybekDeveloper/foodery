...
export default function HomePage() {
  ...
  return (
    <main className="font-montserrat pt-20 space-y-6 flex justify-center items-center gap-5 flex-col">
      <div className="w-11/12 max-w-[1440px] mx-auto flex flex-col items-center gap-2 pt-8">
        <motion.h1
          ...
          className="font-montserrat text-2xl md:text-3xl lg:text-4xl font-bold text-center text-primary"
        >
      ...
      <div className="w-11/12 max-w-[1440px] mx-auto flex flex-col items-center gap-1">
        ...
        >
          <Link href="/">
            <Button className="text-xl hover:bg-primary hover:opacity-90 hover:ring-1 transition-all duration-200 ease-linear">
              Создать Приложения
            </Button>
          </Link>
        </motion.div>
